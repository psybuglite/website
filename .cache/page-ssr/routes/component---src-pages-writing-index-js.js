exports.id = "component---src-pages-writing-index-js";
exports.ids = ["component---src-pages-writing-index-js"];
exports.modules = {
...
/***/ "./src/pages/writing/index.js?export=default":
/*!***************************************************!*\
  !*** ./src/pages/writing/index.js?export=default ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const Writing = () => {
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_layout__WEBPACK_IMPORTED_MODULE_2__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("main", {
    className: "w-full px-4"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    className: "border-b-2 border-[#323232] pb-24 max-w-[1080px] pt-48 mx-auto"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", {
    className: "text-[52px] cursive"
  }, "Writing"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "max-w-3xl py-3"
  }, "Articles on design engineering covering project case studies, thought process, front-end strategy, techniques and best practices, focused on HTML, CSS, SVG, accessiblity, and everything in between."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    className: "pt-12"
    ...
    className: "text-[24px] link"
  }, "How to fix 'document not defined' in Gatsby Build")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "my-4 max-w-2xl"
  }, "The error ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "small-code"
  }, "`document is not defined`"), " or ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span", {
    className: "small-code"
  }, "`window is not defined`"), "window is not defined you see when building a gatsby project is as a result of gatsby attempting to query the DOM on the server as it is server-side rendering.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", {
    className: "mb-4 py-4"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link, {
    ...
    className: "text-[24px] link"
  }, " How to Set Up React Project on a Virtual Server")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    className: "my-4 max-w-2xl"
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Writing);
...
;
//# sourceMappingURL=component---src-pages-writing-index-js.js.map