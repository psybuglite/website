...
const index = require('./index-f6fc0a5c.js');
const languages = require('./languages-55ac0934.js');
...
function loadTheme(theme) {
  ...
  switch (theme) {
    case languages.DeckdeckgoHighlightCodeCarbonTheme['3024-NIGHT']:
      return Promise.resolve().then(function () { return require('./3024-night-4262d2a3.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['A11Y-DARK']:
      return Promise.resolve().then(function () { return require('./a11y-dark-c6f60467.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['BASE16-DARK']:
      return Promise.resolve().then(function () { return require('./base16-dark-d1487df1.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['BASE16-LIGHT']:
      return Promise.resolve().then(function () { return require('./base16-light-633c9aff.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.BLACKBOARD:
      return Promise.resolve().then(function () { return require('./blackboard-4066b894.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.COBALT:
      return Promise.resolve().then(function () { return require('./cobalt-e53cb040.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.DUOTONE:
      return Promise.resolve().then(function () { return require('./duotone-974448a8.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.HOPSCOTCH:
      return Promise.resolve().then(function () { return require('./hopscotch-7344e034.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.LUCARIO:
      return Promise.resolve().then(function () { return require('./lucario-d2c257ec.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.MATERIAL:
      return Promise.resolve().then(function () { return require('./material-39d2cbe5.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.MONOKAI:
      return Promise.resolve().then(function () { return require('./monokai-bef4fa6a.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['NIGHT-OWL']:
      return Promise.resolve().then(function () { return require('./night-owl-1ed27014.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.NORD:
      return Promise.resolve().then(function () { return require('./nord-34e6a28b.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['OCEANIC-NEXT']:
      return Promise.resolve().then(function () { return require('./oceanic-next-6ae3ec4f.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['ONE-DARK']:
      return Promise.resolve().then(function () { return require('./one-dark-bd2eb2a0.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['ONE-LIGHT']:
      return Promise.resolve().then(function () { return require('./one-light-476c927e.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.PANDA:
      return Promise.resolve().then(function () { return require('./panda-86d55d62.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.PARAISO:
      return Promise.resolve().then(function () { return require('./paraiso-e8144c44.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.SETI:
      return Promise.resolve().then(function () { return require('./seti-2e70044d.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['SHADES-OF-PURPLE']:
      return Promise.resolve().then(function () { return require('./shades-of-purple-f3b0acff.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['SOLARIZED-DARK']:
      return Promise.resolve().then(function () { return require('./solarized-dark-eaed57ec.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme['SOLARIZED-LIGHT']:
      return Promise.resolve().then(function () { return require('./solarized-light-6bfc21a2.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.SYNTHWAVE:
      return Promise.resolve().then(function () { return require('./synthwave-3e4b9467.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.TWILIGHT:
      return Promise.resolve().then(function () { return require('./twilight-d719f45a.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.VERMINAL:
      return Promise.resolve().then(function () { return require('./verminal-692a9e97.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.VSCODE:
      return Promise.resolve().then(function () { return require('./vscode-d1d4d3c8.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.YETI:
      return Promise.resolve().then(function () { return require('./yeti-30f3259d.js'); });
    case languages.DeckdeckgoHighlightCodeCarbonTheme.ZENBURN:
      return Promise.resolve().then(function () { return require('./zenburn-83f0d557.js'); });
    default:
      return Promise.resolve().then(function () { return require('./dracula-9d5d1af6.js'); });
  }
}
...
const loadGoogleFonts = async (terminal) => {
  if (terminal === languages.DeckdeckgoHighlightCodeTerminal.UBUNTU) {
...
const loadMainScript = ({ lang, reload = false, prismLanguageLoaded }) => {
  return new Promise(async (resolve) => {
    ...
    const definition = languages.deckdeckgoHighlightCodeLanguages[lang];
...
const HighlightCode = class {
  constructor(hostRef) {
    ...
    this.prismLanguageError = index.createEvent(this, "prismLanguageError", 7);
    /**
     ...
     */
    this.terminal = languages.DeckdeckgoHighlightCodeTerminal.CARBON;
    /**
     ...
     */
    this.theme = languages.DeckdeckgoHighlightCodeCarbonTheme.DRACULA;
  ...
  async loadTheme() {
    if (this.terminal !== languages.DeckdeckgoHighlightCodeTerminal.CARBON || !this.theme) {
  ...
  parse() {
    if (!this.language || !languages.deckdeckgoHighlightCodeLanguages[this.language]) {
      return;
    }
  ...
  async loadRequiredLanguages() {
    ...
    const definition = languages.deckdeckgoHighlightCodeLanguages[this.language];
  ...
  render() {
    var _a;
    const hostClass = {
      'deckgo-highlight-code-carbon': this.terminal === languages.DeckdeckgoHighlightCodeTerminal.CARBON,
      'deckgo-highlight-code-ubuntu': this.terminal === languages.DeckdeckgoHighlightCodeTerminal.UBUNTU,
      'deckgo-highlight-code-papyrs': this.terminal === languages.DeckdeckgoHighlightCodeTerminal.PAPYRS
    };
    if (this.terminal === languages.DeckdeckgoHighlightCodeTerminal.CARBON) {
      hostClass[`deckgo-highlight-code-theme-${this.theme}`] = true;
    }
    return (index.h(index.Host, { class: hostClass }, this.renderCarbon(), this.renderUbuntu(), this.renderHighlightStyle(), index.h("div", { class: "container", ref: (el) => (this.refContainer = el) }, index.h("code", { class: ((_a = this.highlightLines) === null || _a === void 0 ? void 0 : _a.length) > 0 ? 'highlight' : undefined, ref: (el) => (this.refCode = el) }), index.h("slot", { name: "code" }), this.editable && index.h("deckgo-highlight-code-edit", { label: this.editableLabel }))));
  }
  renderHighlightStyle() {
    if (!this.highlightLines || this.highlightLines.length <= 0) {
      return undefined;
    }
    return index.h(HighlightStyle, Object.assign({}, this.highlightRows));
  }
  renderCarbon() {
    if (this.terminal !== languages.DeckdeckgoHighlightCodeTerminal.CARBON) {
      return undefined;
  ...
  renderUbuntu() {
    if (this.terminal !== languages.DeckdeckgoHighlightCodeTerminal.UBUNTU) {
      return undefined;
    }
  ...
  renderUbuntuCircle(mode) {
    ...
    return (index.h("div", { class: mode }, index.h("span", { innerHTML: symbol })));
  }
...
const Edit = class {
  constructor(hostRef) {
    index.registerInstance(this, hostRef);
    this.editCode = index.createEvent(this, "editCode", 7);
  }
  render() {
    return (index.h("button", { onClick: () => this.editCode.emit(), "aria-label": this.label || 'Edit code', part: "edit-button" }, index.h("svg", { xmlns: "http://www.w3.org/2000/svg", height: "24px", viewBox: "0 0 24 24", width: "24px", fill: "currentColor", part: "edit-icon" }, index.h("path", { d: "M0 0h24v24H0z", fill: "none" }), index.h("path", { d: "M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04c.39-.39.39-1.02 0-1.41l-2.34-2.34c-.39-.39-1.02-.39-1.41 0l-1.83 1.83 3.75 3.75 1.83-1.83z" }))));
  }
};
Edit.style = editCss;

exports.deckgo_highlight_code = HighlightCode;
exports.deckgo_highlight_code_edit = Edit;
