import { Build, h, proxyCustomElement, HTMLElement, createEvent, Host } from '@stencil/core/internal/client';
import { d as defineCustomElement$2 } from './edit.js';
...
const deckdeckgoHighlightCodeLanguages = {
  ...
  cil: { title: 'CIL' },
  cilkc: { title: 'Cilk/C', require: ['c'] },
  'cilk-c': { title: 'cilk-c', main: 'cilkc', require: ['c'] },
  cilkcpp: { title: 'Cilk/C++', require: ['cpp'] },
  'cilk-cpp': { title: 'cilk-cpp', main: 'cilkcpp', require: ['cpp'] },
  cilk: { title: 'cilk', main: 'cilkcpp', require: ['cpp'] },
  ...
  mustache: { title: 'Mustache', main: 'handlebars', require: ['markup-templating'] },
...
const scriptSrc = (language) => {
  const { prismjs_cdn } = Build.isBrowser ? window : undefined;
...
const HighlightCode = /*@__PURE__*/ proxyCustomElement(class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  static get style() { return highlightCodeCss; }
}, [1, "deckgo-highlight-code", {
    "language": [513],
    "highlightLines": [513, "highlight-lines"],
    "lineNumbers": [516, "line-numbers"],
    "terminal": [513],
    "editable": [4],
    "editableLabel": [1, "editable-label"],
    "theme": [513],
    "revealProgress": [1025, "reveal-progress"],
    "themeStyle": [32],
    "loaded": [32],
    "highlightRows": [32],
    "load": [64],
    ...
    "nextHighlight": [64],
    "prevHighlight": [64]
  }, [[5, "prismLanguageLoaded", "onLanguageLoaded"], [5, "prismLanguageError", "onLanguageError"]]]);
function defineCustomElement$1() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["deckgo-highlight-code", "deckgo-highlight-code-edit"];
  components.forEach(tagName => { switch (tagName) {
    case "deckgo-highlight-code":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, HighlightCode);
      }
      break;
...
const DeckgoHighlightCode = HighlightCode;
const defineCustomElement = defineCustomElement$1;

export { DeckdeckgoHighlightCodeTerminal as D, DeckgoHighlightCode, DeckdeckgoHighlightCodeCarbonTheme as a, deckdeckgoHighlightCodeLanguages as d, defineCustomElement };
