  ...
  return (
    <CaseStudy>
      <main className="w-full">
                ...
                {({ theme, toggleTheme }) => (
                  <label className="relative cursor-pointer block p-3 ">
                    ...
                    <span className="block">
                      ...
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <g clip-path="url(#clip0_2570_1749)">
                      <path d="M3.23239 17.197C3.12243 17.197 3.01247 17.1551 2.92856 17.0712C2.76079 16.9034 2.76079 16.6313 2.92856 16.4635L5.46626 13.9258L6.07395 14.5335L3.53622 17.0712C3.45231 17.1551 3.34235 17.197 3.23239 17.197Z" fill="#414141"/>
                      <path d="M4.01855 10.4297H0.429688C0.192383 10.4297 0 10.2373 0 10C0 9.7627 0.192383 9.57031 0.429688 9.57031H4.01855V10.4297Z" fill="#414141"/>
                      <path d="M5.4663 6.07427L2.92856 3.53653C2.76079 3.36872 2.76079 3.09665 2.92856 2.92884C3.09638 2.76103 3.36841 2.76103 3.53626 2.92884L6.07395 5.46657L5.4663 6.07427Z" fill="#414141"/>
                      <path d="M9.5709 4.01855V0.452422C9.57051 0.444883 9.57031 0.437305 9.57031 0.429688C9.57031 0.192383 9.7627 0 10 0C10.0038 0 10.0077 3.90625e-05 10.0116 0.00015625C10.2438 0.00601563 10.4303 0.196094 10.4303 0.429727V4.01859H9.5709V4.01855Z" fill="#414141"/>
                      <path d="M13.9258 5.46657L16.4635 2.92884C16.6313 2.76103 16.9034 2.76103 17.0712 2.92884C17.2389 3.09665 17.2389 3.36872 17.0712 3.53653L14.5335 6.07427L13.9258 5.46657Z" fill="#414141"/>
                      <path d="M19.5703 10.4297H15.9814V9.57034H19.5638C19.8038 9.56761 20 9.7605 20 9.99995C20 10.2373 19.8076 10.4297 19.5703 10.4297Z" fill="#414141"/>
                      <path d="M16.7673 17.197C16.6573 17.197 16.5474 17.1551 16.4635 17.0712L13.9258 14.5335L14.5335 13.9258L17.0712 16.4635C17.2389 16.6313 17.2389 16.9034 17.0712 17.0712C16.9873 17.1551 16.8773 17.197 16.7673 17.197Z" fill="#414141"/>
                      <path d="M10.001 20C9.76367 20 9.57129 19.8076 9.57129 19.5703V15.9814H10.4307V19.5703C10.4307 19.8076 10.2383 20 10.001 20Z" fill="#414141"/>
                      <path d="M17.3423 12.5765L16.0678 12.0486C16.2853 11.4051 16.4034 10.7161 16.4034 10.0001C16.4034 9.28434 16.2851 8.59578 16.0677 7.9525L17.3426 7.42445C17.5618 7.33363 17.6659 7.0823 17.5751 6.86305C17.4843 6.64383 17.233 6.53965 17.0137 6.63051L15.7385 7.15867C15.1162 5.90547 14.0957 4.88348 12.8436 4.2591L13.3758 2.97437C13.4666 2.75512 13.3625 2.50379 13.1432 2.41297C12.9239 2.32211 12.6726 2.42625 12.5818 2.64551L12.0506 3.92789C11.4043 3.7082 10.712 3.58895 9.99228 3.58895C9.27822 3.58895 8.59115 3.70641 7.94912 3.92281L7.42177 2.64973C7.33099 2.43051 7.07966 2.32633 6.86036 2.41719C6.64111 2.50801 6.53701 2.75934 6.62783 2.97859L7.15529 4.25195C5.89853 4.87477 4.874 5.89762 4.24911 7.15312L2.98681 6.63027C2.76755 6.53941 2.51622 6.64355 2.4254 6.86281C2.33458 7.08207 2.43868 7.3334 2.65794 7.42422L3.91845 7.94633C3.69978 8.59133 3.58115 9.28211 3.58115 10.0001C3.58115 10.7183 3.69986 11.4094 3.91872 12.0546L2.65822 12.5767C2.43896 12.6675 2.33486 12.9189 2.42568 13.1381C2.49419 13.3036 2.65419 13.4035 2.82283 13.4035C2.87759 13.4035 2.93333 13.3929 2.98708 13.3707L4.24947 12.8478C4.87431 14.1027 5.89841 15.1252 7.15462 15.7479L6.62716 17.0212C6.53634 17.2405 6.64044 17.4918 6.8597 17.5827C6.91345 17.6049 6.96915 17.6155 7.02396 17.6155C7.19255 17.6155 7.35259 17.5155 7.42111 17.3501L7.94841 16.0771C8.5906 16.2937 9.27794 16.4112 9.99224 16.4112C10.7122 16.4112 11.4047 16.2919 12.0513 16.0721L12.5797 17.3477C12.6482 17.5132 12.8082 17.6131 12.9769 17.6131C13.0316 17.6131 13.0874 17.6025 13.1411 17.5803C13.3604 17.4895 13.4645 17.2381 13.3736 17.0189L12.8443 15.7408C14.0958 15.1165 15.1157 14.0949 15.7379 12.8421L17.0135 13.3705C17.0672 13.3928 17.1229 13.4033 17.1777 13.4033C17.3463 13.4033 17.5063 13.3034 17.5749 13.138C17.6656 12.9187 17.5615 12.6673 17.3423 12.5765ZM9.99224 15.5518C6.93099 15.5518 4.44048 13.0613 4.44048 10.0001C4.44048 6.93883 6.93099 4.44832 9.99224 4.44832C13.0535 4.44832 15.544 6.93883 15.544 10.0001C15.544 13.0613 13.0535 15.5518 9.99224 15.5518Z" fill="#313131"/>
                      </g>
                      <defs>
        ...
        <section className="max-w-[1080px] mx-auto border-b md:grid md:grid-cols-5 border-[#999999] dark:border-[#444444] px-4 py-16">
          <div className="col-span-2 pt-8">
            <h1 className="cursive text-[14px] md:text-[16px]">User Research</h1>
          </div>
          <div className="col-span-3 pt-8">
        ...
        <section className="max-w-[1080px] mx-auto border-b md:grid md:grid-cols-5 border-[#999999] dark:border-[#444444] px-4 py-16">
          <div className="col-span-2 pt-8">
            <h1 className="cursive text-[14px] md:text-[16px]">Product Direction</h1>
          </div>
          <div className="col-span-3 pt-8">
        ...
        <section className="max-w-[1080px] mx-auto border-b md:grid md:grid-cols-5 border-[#999999] dark:border-[#444444] px-4 py-16">
          <div className="col-span-2 pt-8">
            <h1 className="cursive text-[14px] md:text-[16px]">User Flows and User Journeys</h1>
          </div>
          <div className="col-span-3 pt-8">
            <p className="pb-6 font-semibold">"Make it so easy to order, that while browsing our lifestyle content, I can buy a phone case at a red light before it turns green."</p>
            <p className="pb-6 italic text-gray-500">With multiple currency accounts and different products all in one platform, the process of navigating multiple user journeys and flows made the application design complex and bloated from the very start. .</p>
        ...
        <section className="max-w-[1080px] mx-auto border-b md:grid md:grid-cols-5 border-[#999999] dark:border-[#444444] px-4 py-16">
          <div className="col-span-2 pt-8">
            <h1 className="cursive text-[14px] md:text-[16px]">Branding, Style, and Design System</h1>
          </div>
          <div className="col-span-3 pt-8">
            <p className="pb-6 font-semibold">"Make it so easy to order, that while browsing our lifestyle content, I can buy a phone case at a red light before it turns green."</p>
            <p className="pb-6 italic text-gray-500">With multiple currency accounts and different products all in one platform, the process of navigating multiple user journeys and flows made the application design complex and bloated from the very start. .</p>
        ...
        <section className="max-w-[1080px] mx-auto border-b md:grid md:grid-cols-5 border-[#999999] dark:border-[#444444] px-4 py-16">
          <div className="col-span-2 pt-8">
            <h1 className="cursive text-[14px] md:text-[16px]">Wireframing and Feedback</h1>
          </div>
          <div className="col-span-3 pt-8">
            <p className="pb-6 font-semibold">"Make it so easy to order, that while browsing our lifestyle content, I can buy a phone case at a red light before it turns green."</p>
            <p className="pb-6 italic text-gray-500">With multiple currency accounts and different products all in one platform, the process of navigating multiple user journeys and flows made the application design complex and bloated from the very start. .</p>
        ...
        <section className="max-w-[1080px] mx-auto border-b md:grid md:grid-cols-5 border-[#999999] dark:border-[#444444] px-4 py-16">
          <div className="col-span-2 pt-8">
            <h1 className="cursive text-[14px] md:text-[16px]">User Interface & Prototype</h1>
          </div>
          <div className="col-span-3 pt-8">
            <p className="pb-6 font-semibold">"Make it so easy to order, that while browsing our lifestyle content, I can buy a phone case at a red light before it turns green."</p>
            <p className="pb-6 italic text-gray-500">With multiple currency accounts and different products all in one platform, the process of navigating multiple user journeys and flows made the application design complex and bloated from the very start. .</p>
