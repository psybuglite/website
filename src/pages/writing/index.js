              ...
              <ul className="none">
                <li className="mb-4 py-4">
                  <Link to="/writing/window-document-not-defined-gatsby-build" className="link-item">
                    <h3 className="text-[24px] inline link">How to fix 'document not defined' in Gatsby Build</h3>
                  </Link>
                ...
                <li className="mb-4 py-4">
                  <Link to="/writing/how-to-setup-react-project-on-a-virtual-private-server" className="link-item">
                    <h3 className="text-[24px] inline link"> How to Set Up React Project on a Virtual Server</h3>
                  </Link>
